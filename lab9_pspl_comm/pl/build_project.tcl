...
#
# Generated by Vivado on Fri Jul 05 15:22:46 +0530 2024
...
#
#    "C:/Users/REU/Documents/eld-labs/lab9_pspl_comm/pl/srcs/bd/zps_bram/hdl/zps_bram_wrapper.v"
#
#*****************************************************************************************
...
set files [list \
 [file normalize "${origin_dir}/srcs/bd/zps_bram/hdl/zps_bram_wrapper.v"] \
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "zps_bram_wrapper" -objects $obj
...
# Proc to create BD zps_bram
proc cr_bd_zps_bram { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name zps_bram
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_mem_intercon_M00_AXI] [get_bd_intf_pins axi_mem_intercon/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
...
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 5 -x 1290 -y 160 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 5 -x 1290 -y 320 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 190 -y 340 -defaultsOSRD
preplace inst axi_bram_ctrl_0 -pg 1 -lvl 3 -x 880 -y 240 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 2 -x 540 -y 160 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 1 -x 190 -y 160 -defaultsOSRD
preplace inst axi_bram_ctrl_0_bram -pg 1 -lvl 4 -x 1150 -y 240 -defaultsOSRD
preplace inst system_ila_0 -pg 1 -lvl 3 -x 880 -y 80 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 -10 440 400 280 700
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 0 450 380
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 2 380 290 720
preplace netloc processing_system7_0_DDR 1 1 4 NJ 300 730J 160 NJ 160 NJ
preplace netloc axi_mem_intercon_M00_AXI 1 2 1 710 60n
preplace netloc processing_system7_0_FIXED_IO 1 1 4 NJ 320 NJ 320 NJ 320 NJ
preplace netloc axi_bram_ctrl_0_BRAM_PORTA 1 3 1 NJ 240
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 390 100n
levelinfo -pg 1 -30 190 540 880 1150 1290
pagesize -pg 1 -db -bbox -sgen -30 0 1400 710
"
}
...
# End of cr_bd_zps_bram()
cr_bd_zps_bram ""
set_property REGISTERED_WITH_MANAGER "1" [get_files zps_bram.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files zps_bram.bd ] 
